...
const cipher = (offset, string) => {//nossa function recebe dois parâmentros string=texto para ser cifrado e offset= o número de posições que queremos mover para a direita no alfabeto ASCII
